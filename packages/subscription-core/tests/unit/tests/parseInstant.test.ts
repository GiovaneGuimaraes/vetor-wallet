...
describe('parseInstant', () => {
  ...
  test('aceita ISO 8601 com Z', () => {
    expect(parseInstant('2026-08-01T12:00:00.000Z').toISOString()).toBe(
  ...
  test('respeita offset explícito em vez de forçar UTC', () => {
    ...
    expect(parseInstant('2026-08-01T12:00:00-0300').toISOString()).toBe(
      '2026-08-01T15:00:00.000Z',
    );
  });

  test('ignora espaço em volta', () => {
    expect(parseInstant('  2026-08-01 12:00:00  ').toISOString()).toBe(
      '2026-08-01T12:00:00.000Z',
    );
  });
