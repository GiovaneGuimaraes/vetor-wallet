...
- Os defaults (valor inicial = saldo do `summary`, taxa = derivada) chegam depois do fetch, então são aplicados por efeito **só enquanto o usuário não tocou no campo** (`simTouched`) — digitar não é sobrescrito pelo refetch.
