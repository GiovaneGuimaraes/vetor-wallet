...
### [2026-09-13] Migração para AppSync + Relay: decisões 1 e 2 respondidas, faltam 3 e 4
- **Origem**: orquestrador (pedido do humano, 2026-09-13)
- **Bloqueia**: a fase 1 da migração. Nada entra no backlog sem as três que sobraram.
- **O plano completo**: [`plano-appsync-relay.md`](./plano-appsync-relay.md) — **reescrito em 2026-09-14** em cima da decisão 1 e do monorepo da OCA.
...
- **Decisão 3 — onde ficam os tokens do Cognito: ABERTA.** (1️⃣) **padrão AppSync**, token só em memória, nunca `localStorage` — é o que a OCA faz (`aws-amplify`); (2️⃣) **manter um BFF** que guarda a sessão e assina as chamadas. **Recomendo a 1️⃣.**
- **Decisão 4 — teto de custo: ABERTA, e ficou mais urgente com a Aurora.** Turso cobraria por uso; a Aurora Serverless v2 cobra **enquanto o cluster existir**, com o app parado. O **AWS Budget com alarme por e-mail** virou o passo 1 da fase 1, não mais "antes do primeiro deploy".
