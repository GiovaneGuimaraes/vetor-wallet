...
### [2026-09-13] Migração para AppSync + Relay: decisão 1 respondida, faltam 2, 3 e 4
...
- **Decisão 2 — infra as code: ABERTA, e mudou de forma.** Não é mais "console × CDK": a OCA usa **`carlin`** (CloudFormation) em toda a infra. **Recomendo `carlin`** — copiar a referência inteira é mais barato que traduzi-la para CDK.
