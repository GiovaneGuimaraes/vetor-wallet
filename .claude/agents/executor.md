...
> O modelo deste frontmatter (`sonnet`) é apenas o default: o orquestrador roteia o modelo por complexidade da tarefa via parâmetro `model` da ferramenta Agent (baixa → Haiku, alta → Opus 5) — ver "Roteamento de modelos" em `docs/multi-agent/README.md`.
